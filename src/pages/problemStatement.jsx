...
function ProblemStatement() {
    ...
    <div className="container mx-auto max-w-7xl my-20">
      ...
      <div className="font-semibold">
        <p className="mb-4">
          {data.problem.statement} Lorem ipsum dolor sit amet consectetur
          adipisicing elit. Libero eligendi sequi dolor, mollitia provident sed,
          repellat dolorum ut in laudantium inventore consequatur nobis
          doloribus. Aperiam inventore alias ratione, mollitia sapiente sint
          laborum ipsam non numquam, nostrum, porro magni praesentium sequi.
        </p>
      ...
      <div>
        <Link to={`/submit/${data.id}`}>
          <button className="bg-blue-300 px-2 py-1 rounded-lg text-white">
            Submit
          </button>
        </Link>
      </div>
